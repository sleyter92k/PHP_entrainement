      ...
      <section class="row">
        <div class="col-8">
            ...
            <?php
                ...
                echo "<tr><th scope=\"row\">".$ligne['id']."</th><td>".$ligne['title']."</td><td>".$ligne['zip_code']."</td><td>".$ligne['city']."</td><td>".$ligne['type']."</td><td>".$ligne['price']."</td><td><a href=\"modifi_annonces.php?identity=$ligne[id]\" class=\"btn btn-warning\">Modifié</a></td></tr>";
